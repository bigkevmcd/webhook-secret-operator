...
func New(c *scm.Client) *SCMHooksClient {
	return &SCMHooksClient{Client: c}
}
...
func (c *SCMHooksClient) Create(ctx context.Context, repo, hookURL, secret string) (string, error) {
